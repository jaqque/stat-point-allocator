...
point_cost = (ability / 10 + 1)
points = ((level*level + level )/2 + level - 2)

strcurrent = strinit + stradd
endcurrent = endinit + endadd
agicurrent = agiinit + agiadd
intcurrent = intinit + intadd
chacurrent = chainit + chaadd
lckcurrent = lckinit + lckadd
